...
import com.app.tanyahukum.view.AddAppointmentActivity;
...
@CustomScope
@Component(dependencies = NetComponent.class,modules = AddAppointmentActivityModule.class)
public interface AddAppointmentActivityComponent {
