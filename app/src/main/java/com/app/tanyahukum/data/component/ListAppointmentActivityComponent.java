...
@CustomScope
@Component(dependencies = NetComponent.class,modules = ListAppointmnetActivityModule.class)
public interface ListAppointmentActivityComponent {
    void inject(ListAppointmentActivity listAppointmentActivity);
}
